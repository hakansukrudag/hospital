...
<div class="container">
    ...
    <div class="row" style="margin-bottom: 100px;">
        <form class="form-horizontal" id="userForm" method="post" action="{{ route('storeUserProfile') }}">
                   @csrf
                   ...
                   <div class="form-group">
                       ...
                       <div class="col-sm-10">
                           <input type="date" class="form-control" name="age" id="age" value="{{ $dob }}" placeholder="Age">
                   ...
                   <div class="form-group">
                       ...
                       <div class="col-sm-10">
                           <input type="text" class="form-control" name="image_path" id="image_path" value="{{ $user->image_path }}"
