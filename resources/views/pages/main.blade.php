...
@section('content')
    ...
    <!--slider start-->
    <div class="health_slider style_2">
    	<div class="owl-carousel owl-theme">
    		<div class="item">
    			<div class="hlc_slider_details">
    				<img class="animated fadeInDown" src="{{ asset('images/slider/Doctor-_-Patient_1_1920x950.jpg') }}" alt="...">
    		...
    		<div class="item">
    			<div class="hlc_slider_details">
    				<img class="animated fadeInDown" src="{{ asset('images/slider/Doctor-_-Patient_2_1920x950.jpg') }}" alt="...">
    				<div class="hlc_slider_details_text">
    					<div class="container">
    						<div class="row">
    							<div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="item">
          <div class="hlc_slider_details">
            <img class="animated fadeInDown" src="{{ asset('images/slider/Doctor-_-Patient_3_1920x950.jpg') }}" alt="...">
            <div class="hlc_slider_details_text">
              <div class="container">
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
          ...
          <div class="our_partners">
            <div id="our_partners_slider" class="owl-carousel owl-theme">
              <div class="our_partners_slider_item"> <img src="http://placehold.it/150X50" alt="" width="142" height="40"  /> </div>
              <div class="our_partners_slider_item"> <img src="http://placehold.it/150X50" alt="" width="142" height="40"  /> </div>
              <div class="our_partners_slider_item"> <img src="http://placehold.it/150X50" alt="" width="142" height="40"  /> </div>
              <div class="our_partners_slider_item"> <img src="http://placehold.it/150X50" alt="" width="142" height="40"  /> </div>
              <div class="our_partners_slider_item"> <img src="http://placehold.it/150X50" alt="" width="142" height="40"  /> </div>
